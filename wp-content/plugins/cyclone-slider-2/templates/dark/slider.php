...
?>
<div tabindex="0" class="row cycloneslider cycloneslider-template-dark cycloneslider-width-<?php echo esc_attr( $slider_settings['width_management'] ); ?>"
    ...
    >
    <div class=" col-md-12 cycloneslider-slides cycle-slideshow"
